/*
Custom (ModernBERT) Sentiment Analysis Pipeline
==============================================

This pipeline performs real-time sentiment analysis of customer messages using
the custom fine-tuned ModernBERT model hosted on Hugging Face.
It mirrors the local model pipeline but uses the custom model UDF.
*/

SET 'job.name' = 'Custom Model Sentiment Analysis Pipeline';

-- ============================================================================
-- 1. Register Python UDF for Custom Sentiment Analysis
-- ============================================================================

CREATE TEMPORARY FUNCTION analyze_message_sentiment AS 'sentiment_custom_model_udf.analyze_message_sentiment' LANGUAGE PYTHON;
...
CREATE TABLE customer_messages (
    ...
    'properties.group.id' = 'flink-sentiment-custom-model',
